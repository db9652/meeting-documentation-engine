...
def summarize_meeting_with_ollama(metadata_path: str, model: str = "llama3.2:latest", target_chapters: int = 7):
...
TAKEAWAY: <One bold actionable conclusion or insight>"""
    ...
    md_output_path = os.path.join(output_dir, "executive_summary.md")
...
<div class="container">
  ...
  {"".join(html_cards)}
    ...
    html_output_path = os.path.join(output_dir, "executive_summary.html")
